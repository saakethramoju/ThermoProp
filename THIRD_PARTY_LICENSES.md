...
ThermoProp depends on the following third-party packages.
...
ThermoProp is an independent project and is not affiliated with, endorsed by, or sponsored by the CoolProp, PYroMat, RocketProps, NumPy, or SciPy projects.
