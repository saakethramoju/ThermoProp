...
print("Gamma equilibrium Cp_eq/Cv_eq:", chamber.gamma_equilibrium)
print("Gamma_s / isentropic exponent:", chamber.gamma_s)
print("(d ln V / d ln P)_T:", chamber.dlnv_dlnp_const_t)
print("(d ln V / d ln T)_P:", chamber.dlnv_dlnt_const_p)
